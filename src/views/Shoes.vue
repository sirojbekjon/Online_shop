  ...
  <v-container>
    <v-row>
      ...
      >
        ...
        >
          <v-img v-if="shoe.fileUpload && shoe.fileUpload.contentType!=='video/mp4'" height="350" :src="`https://vds.arzongina.uz/upload/${shoe.fileUpload.name}`"></v-img>
          ...
          <v-toolbar color="transparent" class="mt-n7" flat>
            ...
            <v-spacer></v-spacer>
            <v-avatar rounded class="mr-2" width="100px">
              <div class="three">
                <div class="four">
