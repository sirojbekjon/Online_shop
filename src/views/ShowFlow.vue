  ...
  <div class="container" style="color: #b9b9b9">
    <div class="row pt-5">
      ...
      <div class="col-md-4 col-8">
        <v-img v-if="flow_product.product.fileUpload.contentType!=='video/mp4'" width="100%" height="auto" :src="`http://192.168.1.4:8088/upload/${flow_product.product.fileUpload.name}`"></v-img>
        <video  controls v-else-if="flow_product.product.fileUpload.contentType === 'video/mp4'" width="100%"  height="auto">
          <source  :src="`http://192.168.1.4:8088/upload/${flow_product.product.fileUpload.name}`" type="video/mp4">
        </video>
      </div>
